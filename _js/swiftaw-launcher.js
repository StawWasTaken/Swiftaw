/* ════════════════════════════════════════════════════════════════════════════
   ...
   Navigation between products only. Nothing here signs you in or reads a
   product's session. The account is a separate button in the same dock,
   owned by swiftaw-account.js.
