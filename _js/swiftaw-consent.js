/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Swiftaw, Lifecheck, Supernova, Fortized web and Hereld all load this file.
   ...
   · Necessary storage is listed and locked, never shown as a choice.
   · "Necessary only" sits beside "Accept", at the same level of the card.
   · Escalating raises prominence only. No option is removed in the centred
     state and no pressure language is added.
   · The decision is stored locally and re-asked when the categories or the
